namespace TexasHoldem.AI.Sparta.Helpers.HandEvaluators
{
    ...
    internal class PreFlopHandEvaluator : IPreFlopHandEvaluator
    {
        ...
        private static readonly double[,] StartingHandTablePercents =
        {
                ...
                { 64.46, 82.11, 62.40, 61.47, 60.58, 58.63, 56.79, 55.84, 55.80, 55.83, 55.88, 55.07, 55.23 },  // AKo KK KQs KJs KTs K9s K8s K7s K6s K5s K4s K3s K2s
                ...
                { 55.73, 50.22, 46.92, 43.86, 41.05, 38.08, 36.70, 35.66, 35.00, 35.07, 56.25, 35.72, 33.91 },  // A4o K4o Q4o J4o T4o 94o 84o 74o 64o 54o 44 43s 42s
                { 55.85, 49.33, 46.02, 42.96, 40.15, 37.42, 34.74, 33.71, 33.06, 33.16, 32.06, 55.00, 33.09 },  // A3o K3o Q3o J3o T3o 93o 83o 73o 63o 53o 43o 33 32s
                { 55.94, 48.42, 45.10, 42.04, 39.23, 36.51, 34.08, 31.71, 31.07, 31.19, 30.11, 29.23, 55.00 },  // A2o K2o Q2o J2o T2o 92o 82o 72o 62o 52o 42o 32o 22
        };
